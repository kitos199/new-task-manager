...
const markup = `<div class="bg-white w-full sm:w-[85%] md:w-[80%] lg:w-[70%] max-w-5xl mt-[5%] rounded-t-3xl">
    ...
    <div class="wrapper-cart">
     <div class="flex  bg-[#e5dede] p-5 rounded-xl mb-5 mx-5">
        <p class="task-text text-xl">текст</p>
...
const init = () => {
  ...
  formTask.addEventListener("submit", (e) => {
    ...
    if (text !== "") {
      const markup = `<div class="flex  bg-[#e5dede] p-5 rounded-xl mb-5 mx-5">
        <p class="text-xl text-${task}-500">${text}</p>
        <div class="flex ml-auto gap-5 items-center">
        <input type="checkbox" name="checed" class="w-5 h-5">
...
const updateCart = () => {
  ...
  document.querySelector('.wrapper-cart'), addEventListener("click", (e) => {
